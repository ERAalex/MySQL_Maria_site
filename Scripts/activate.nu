...
let virtual-env = "C:\Users\Герман\Desktop\Phyton + MySql\ПРОЕКТЫ\maria_flask"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "C:\Users\Герман\Desktop\Phyton + MySql\ПРОЕКТЫ\maria_flask\Scripts\deactivate.nu"
